...
class Controller
{
    ...
    public function showCategorias()
    {
        ...
        foreach ($consolas as $consola) {
            ...
            $this->modelCatalogo->showCatalogoEspecifico($consola); //FALTA IMPLEMENTAR, HAY QUE RE-HACER
    ...
    public function showCatalogoEspecifico($consolaElegida)
    {
        ...
        if (!empty($existeConsola)) {
            $categoriaElegida = $this->modelCatalogo->getCatalogoEspecifico($existeConsola);
            $consolas = $this->modelConsolas->getConsolas();
