...
class consolasController
{
    ...
    public function ShowFormConsolaEspecifica(){
        $consolas=$this->consolasModel->getConsolas();
        $this->consolasView->ShowFormConsolaEspecifica($consolas);
           
        if (isset($_POST['ConsolaID'])) {
                $idConsola = $_POST['ConsolaID'];
               
                return header("Location: http://localhost/tpControllerViewSeparado/categoria/$idConsola");
