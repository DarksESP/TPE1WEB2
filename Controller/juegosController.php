...
class juegosController
{
    ...
    public function ShowFormJuegoEspecifico(){
        $juegos=$this->juegosModel->getJuegos();
        $this->juegosView->ShowFormJuegoEspecifico($juegos);
           
        if (isset($_POST['JuegoID'])) {
                $idJuego = $_POST['JuegoID'];
                // Redirige a la URL deseada
                return header("Location: http://localhost/tpControllerViewSeparado/juego/$idJuego");
